...
// This little service worker adds the COOP/COEP headers that ffmpeg.wasm needs
// in order to run. It lets the app work on static hosts (like GitHub Pages)
// that don't let you set response headers yourself.
